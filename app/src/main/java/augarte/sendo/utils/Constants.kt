...
class Constants{
    companion object {
        ...
        var TABLE_USER = "user"
        var TABLE_MEASURETYPE = "measureType"
        var TABLE_DATETYPE = "dateType"
        ...
        var TABLE_MEASUREMENT_CREATEDBY = "createBy"
        ...
        var TABLE_SERIE_CREATEDATE = "createDate"
        var TABLE_SERIE_MODIFYDATE = "modifyDate"

        var TABLE_USER_ID = "id"
        var TABLE_USER_NAME = "name"
        var TABLE_USER_USERNAME = "username"
        var TABLE_USER_EMAIL = "email"
        var TABLE_USER_PASSWORD = "password"
        var TABLE_USER_CREATEDATE = "createDate"
        var TABLE_USER_MODIFYDATE = "modifydate"

        var TABLE_DATETYPE_ID = "id"
        var TABLE_DATETYPE_NAME = "name"
        var TABLE_DATETYPE_CODE = "username"
        var TABLE_DATETYPE_CREATEDATE = "createDate"
        var TABLE_DATETYPE_MODIFYDATE = "modifydate"

        var TABLE_MEASURETYPE_ID = "id"
        var TABLE_MEASURETYPE_NAME = "name"
        var TABLE_MEASURETYPE_CODE = "username"
        var TABLE_MEASURETYPE_CREATEDATE = "createDate"
        var TABLE_MEASURETYPE_MODIFYDATE = "modifydate"
    }
}
